"""Run the scenario_clinical_finisher gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_clinical_finisher"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run clinical-finisher scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_clinical_finisher insert completed successfully")
