"""Run the scenario_metronome gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_metronome"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the-metronome scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_metronome insert completed successfully")
