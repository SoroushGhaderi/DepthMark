"""Run the scenario_territorial_suffocation gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_territorial_suffocation"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run territorial-suffocation scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_territorial_suffocation insert completed successfully")
