"""Run the scenario_elite_shot_stopper gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_elite_shot_stopper"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run elite-shot-stopper scenario query from gold SQL folder"
    )
