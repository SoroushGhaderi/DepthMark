"""Run the scenario_dead_ball_dominance gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_dead_ball_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run dead-ball-dominance scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_dead_ball_dominance insert completed successfully")
