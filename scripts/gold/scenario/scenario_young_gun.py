"""Run the scenario_young_gun gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_young_gun"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run young-gun scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_young_gun insert completed successfully")
