"""Run the scenario_hollow_dominance gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_hollow_dominance"
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_hollow_dominance insert completed successfully")
