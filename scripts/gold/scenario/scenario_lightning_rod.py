"""Run the scenario_lightning_rod gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_lightning_rod"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the-lightning-rod scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_lightning_rod insert completed successfully")
