"""Run the scenario_low_block_heist gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_low_block_heist"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run low-block-heist scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_low_block_heist insert completed successfully")
