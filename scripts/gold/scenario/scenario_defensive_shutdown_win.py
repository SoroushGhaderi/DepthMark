"""Run the scenario_defensive_shutdown_win gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_defensive_shutdown_win"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run defensive-shutdown-win scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_defensive_shutdown_win insert completed successfully")
