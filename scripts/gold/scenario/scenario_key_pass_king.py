"""Run the scenario_key_pass_king gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_key_pass_king"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run key-pass-king scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_key_pass_king insert completed successfully")
