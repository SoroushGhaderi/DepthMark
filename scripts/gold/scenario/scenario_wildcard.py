"""Run the scenario_wildcard gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_wildcard"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run wildcard scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_wildcard insert completed successfully")
