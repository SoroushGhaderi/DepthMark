"""Run the scenario_progressive_powerhouse gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_progressive_powerhouse"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run progressive-powerhouse scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_progressive_powerhouse insert completed successfully")
