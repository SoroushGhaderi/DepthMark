"""Run the scenario_route_one_masterclass gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_route_one_masterclass"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run route-one-masterclass scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_route_one_masterclass insert completed successfully")
