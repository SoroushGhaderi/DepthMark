"""Run the scenario_lead_by_example gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_lead_by_example"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run lead-by-example scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_lead_by_example insert completed successfully")
