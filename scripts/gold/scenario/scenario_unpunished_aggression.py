"""Run the scenario_unpunished_aggression gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_unpunished_aggression"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run unpunished-aggression scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_unpunished_aggression insert completed successfully")
