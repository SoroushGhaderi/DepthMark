"""Run the scenario_away_day_masterclass gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_away_day_masterclass"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run away-day-masterclass scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_away_day_masterclass insert completed successfully")
