"""Run the scenario_war_zone gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_war_zone"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run war-zone scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_war_zone insert completed successfully")
