"""Run the scenario_russian_roulette gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_russian_roulette"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run russian-roulette scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_russian_roulette insert completed successfully")
