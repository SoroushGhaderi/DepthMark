"""Run the scenario_clinical_pivot gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_clinical_pivot"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run clinical-pivot scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_clinical_pivot insert completed successfully")
