"""Run the scenario_great_escape gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_great_escape"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run great-escape scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_great_escape insert completed successfully")
