"""Run the scenario_touchline_terror gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_touchline_terror"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run touchline-terror scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_touchline_terror insert completed successfully")
