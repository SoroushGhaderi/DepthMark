"""Run the scenario_demolition gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_demolition"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run demolition-match scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_demolition insert completed successfully")
