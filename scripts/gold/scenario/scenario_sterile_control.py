"""Run the scenario_sterile_control gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_sterile_control"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run sterile-control scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_sterile_control insert completed successfully")
