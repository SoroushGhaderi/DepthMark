"""Run the scenario_shot_stopper gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_shot_stopper"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run shot-stopper scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_shot_stopper insert completed successfully")
