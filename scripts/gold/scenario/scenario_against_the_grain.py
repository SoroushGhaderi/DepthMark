"""Run the scenario_against_the_grain gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_against_the_grain"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run against-the-grain scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_against_the_grain insert completed successfully")
