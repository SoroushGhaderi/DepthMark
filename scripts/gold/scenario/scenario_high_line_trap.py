"""Run the scenario_high_line_trap gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_high_line_trap"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run high-line-trap scenario query from gold SQL folder"
    )
