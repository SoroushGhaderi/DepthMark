"""Run the scenario_big_chance_killer gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_big_chance_killer"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run big-chance-killer scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_big_chance_killer insert completed successfully")
