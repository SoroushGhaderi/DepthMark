"""Run the scenario_ten_men_stand gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_ten_men_stand"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run ten-men-stand scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_ten_men_stand insert completed successfully")
