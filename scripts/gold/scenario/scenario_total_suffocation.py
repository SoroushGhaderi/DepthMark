"""Run the scenario_total_suffocation gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_total_suffocation"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run total-suffocation scenario query from gold SQL folder"
    )
