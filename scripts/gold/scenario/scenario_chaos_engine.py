"""Run the scenario_chaos_engine gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_chaos_engine"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run chaos-engine scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_chaos_engine insert completed successfully")
