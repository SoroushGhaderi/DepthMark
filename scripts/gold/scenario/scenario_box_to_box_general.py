"""Run the scenario_box_to_box_general gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_box_to_box_general"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run box-to-box-general scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_box_to_box_general insert completed successfully")
