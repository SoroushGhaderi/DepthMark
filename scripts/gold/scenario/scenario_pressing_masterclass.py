"""Run the scenario_pressing_masterclass gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_pressing_masterclass"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run pressing-masterclass scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_pressing_masterclass insert completed successfully")
