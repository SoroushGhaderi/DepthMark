"""Run the scenario_last_gasp gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_last_gasp"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run last-gasp scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_last_gasp insert completed successfully")
