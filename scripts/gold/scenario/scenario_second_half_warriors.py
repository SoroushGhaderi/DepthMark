"""Run the scenario_second_half_warriors gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_second_half_warriors"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run second-half-warriors scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_second_half_warriors insert completed successfully")
