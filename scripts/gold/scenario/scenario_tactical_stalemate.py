"""Run the scenario_tactical_stalemate gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_tactical_stalemate"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run tactical-stalemate scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_tactical_stalemate insert completed successfully")
