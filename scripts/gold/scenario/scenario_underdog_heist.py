"""Run the scenario_underdog_heist gold query against ClickHouse."""
...
TARGET_TABLE = f"{gold_scenarios_db()}.scenario_underdog_heist"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run underdog-heist scenario query from gold SQL folder"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("scenario_underdog_heist insert completed successfully")
