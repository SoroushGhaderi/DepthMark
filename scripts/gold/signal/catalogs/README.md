...
asset path, SHA-256 hash, and byte count.
...
| `sig_match_creativity_playmaking_the_creativity_clash` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_the_creativity_clash.md](sig_match_creativity_playmaking_the_creativity_clash.md) |
| `sig_match_creativity_playmaking_progressive_warfare` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_progressive_warfare.md](sig_match_creativity_playmaking_progressive_warfare.md) |
| `sig_match_creativity_playmaking_long_ball_duel` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_long_ball_duel.md](sig_match_creativity_playmaking_long_ball_duel.md) |
| `sig_match_creativity_playmaking_the_cross_heavy_match` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_the_cross_heavy_match.md](sig_match_creativity_playmaking_the_cross_heavy_match.md) |
| `sig_match_creativity_playmaking_box_entry_chaos` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_box_entry_chaos.md](sig_match_creativity_playmaking_box_entry_chaos.md) |
| `sig_match_creativity_playmaking_big_chance_fest` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_big_chance_fest.md](sig_match_creativity_playmaking_big_chance_fest.md) |
| `sig_match_creativity_playmaking_playmaker_showdown` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_playmaker_showdown.md](sig_match_creativity_playmaking_playmaker_showdown.md) |
| `sig_match_creativity_playmaking_playmaker_to_striker_connection` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_playmaker_to_striker_connection.md](sig_match_creativity_playmaking_playmaker_to_striker_connection.md) |
| `sig_match_creativity_playmaking_assist_provider_battle` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_assist_provider_battle.md](sig_match_creativity_playmaking_assist_provider_battle.md) |
| `sig_match_creativity_playmaking_set_piece_creative_duel` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_set_piece_creative_duel.md](sig_match_creativity_playmaking_set_piece_creative_duel.md) |
| `sig_match_creativity_playmaking_dribbling_battle` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_dribbling_battle.md](sig_match_creativity_playmaking_dribbling_battle.md) |
| `sig_match_creativity_playmaking_unproductive_beauty` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_unproductive_beauty.md](sig_match_creativity_playmaking_unproductive_beauty.md) |
| `sig_match_creativity_playmaking_shot_creation_peak` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_shot_creation_peak.md](sig_match_creativity_playmaking_shot_creation_peak.md) |
| `sig_match_creativity_playmaking_zero_flair_stalemate` | team | creativity | playmaking | `match_team` | active | [sig_match_creativity_playmaking_zero_flair_stalemate.md](sig_match_creativity_playmaking_zero_flair_stalemate.md) |
...
| `sig_team_creativity_playmaking_chance_barrage` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_chance_barrage.md](sig_team_creativity_playmaking_chance_barrage.md) |
| `sig_team_creativity_playmaking_bench_creative_impact` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_bench_creative_impact.md](sig_team_creativity_playmaking_bench_creative_impact.md) |
| `sig_team_creativity_playmaking_crossing_clinic` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_crossing_clinic.md](sig_team_creativity_playmaking_crossing_clinic.md) |
| `sig_team_creativity_playmaking_dribbling_exhibition` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_dribbling_exhibition.md](sig_team_creativity_playmaking_dribbling_exhibition.md) |
| `sig_team_creativity_playmaking_final_third_siege` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_final_third_siege.md](sig_team_creativity_playmaking_final_third_siege.md) |
| `sig_team_creativity_playmaking_sustained_creative_pressure` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_sustained_creative_pressure.md](sig_team_creativity_playmaking_sustained_creative_pressure.md) |
| `sig_team_creativity_playmaking_unlikely_creative_source` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_unlikely_creative_source.md](sig_team_creativity_playmaking_unlikely_creative_source.md) |
| `sig_team_creativity_playmaking_unproductive_flair` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_unproductive_flair.md](sig_team_creativity_playmaking_unproductive_flair.md) |
...
| `sig_team_creativity_playmaking_total_fluidity` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_total_fluidity.md](sig_team_creativity_playmaking_total_fluidity.md) |
| `sig_team_creativity_playmaking_unassisted_goals` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_unassisted_goals.md](sig_team_creativity_playmaking_unassisted_goals.md) |
...
| `sig_team_creativity_playmaking_big_chance_monopoly` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_big_chance_monopoly.md](sig_team_creativity_playmaking_big_chance_monopoly.md) |
...
| `sig_player_creativity_playmaking_assist_hat_trick` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_assist_hat_trick.md](sig_player_creativity_playmaking_assist_hat_trick.md) |
| `sig_player_creativity_playmaking_deadball_wizard` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_deadball_wizard.md](sig_player_creativity_playmaking_deadball_wizard.md) |
| `sig_player_creativity_playmaking_clutch_vision` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_clutch_vision.md](sig_player_creativity_playmaking_clutch_vision.md) |
| `sig_player_creativity_playmaking_unselfish_forward` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_unselfish_forward.md](sig_player_creativity_playmaking_unselfish_forward.md) |
...
| `sig_player_creativity_playmaking_box_to_box_playmaker` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_box_to_box_playmaker.md](sig_player_creativity_playmaking_box_to_box_playmaker.md) |
| `sig_player_creativity_playmaking_final_third_monopoly` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_final_third_monopoly.md](sig_player_creativity_playmaking_final_third_monopoly.md) |
| `sig_player_creativity_playmaking_fullback_playmaker` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_fullback_playmaker.md](sig_player_creativity_playmaking_fullback_playmaker.md) |
| `sig_player_creativity_playmaking_high_value_turnover` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_high_value_turnover.md](sig_player_creativity_playmaking_high_value_turnover.md) |
