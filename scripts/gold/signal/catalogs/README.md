...
| `sig_player_creativity_playmaking_box_penetrator` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_box_penetrator.md](sig_player_creativity_playmaking_box_penetrator.md) |
...
| `sig_player_creativity_playmaking_cross_perfection` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_cross_perfection.md](sig_player_creativity_playmaking_cross_perfection.md) |
...
| `sig_player_creativity_playmaking_isolated_creativity` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_isolated_creativity.md](sig_player_creativity_playmaking_isolated_creativity.md) |
...
| `sig_player_creativity_playmaking_the_quarterback` | player | creativity | playmaking | `match_player` | active | [sig_player_creativity_playmaking_the_quarterback.md](sig_player_creativity_playmaking_the_quarterback.md) |
...
| `sig_team_creativity_playmaking_midfield_engine_vision` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_midfield_engine_vision.md](sig_team_creativity_playmaking_midfield_engine_vision.md) |
| `sig_team_creativity_playmaking_one_sided_vision` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_one_sided_vision.md](sig_team_creativity_playmaking_one_sided_vision.md) |
| `sig_team_creativity_playmaking_set_piece_threat_volume` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_set_piece_threat_volume.md](sig_team_creativity_playmaking_set_piece_threat_volume.md) |
...
| `sig_team_creativity_playmaking_wide_play_monopoly` | team | creativity | playmaking | `match_team` | active | [sig_team_creativity_playmaking_wide_play_monopoly.md](sig_team_creativity_playmaking_wide_play_monopoly.md) |
