"""Run the sig_match_discipline_cards_blood_and_thunder gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_blood_and_thunder"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-blood-and-thunder signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_blood_and_thunder insert completed")
