"""Run the sig_team_shooting_goals_sustained_second_half_siege gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_sustained_second_half_siege"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-sustained-second-half-siege signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_sustained_second_half_siege insert completed")
