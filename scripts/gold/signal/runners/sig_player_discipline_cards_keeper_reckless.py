"""Run the sig_player_discipline_cards_keeper_reckless gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_keeper_reckless"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-keeper-reckless signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_keeper_reckless insert completed")
