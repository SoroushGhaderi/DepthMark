"""Run the sig_match_discipline_cards_referee_strictness gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_referee_strictness"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-referee-strictness signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_referee_strictness insert completed")
