"""Run the sig_team_goalkeeping_defense_shot_blocking_unit gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_shot_blocking_unit"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-shot-blocking-unit signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_shot_blocking_unit insert completed")
