"""Run the sig_team_discipline_cards_away_hostility gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_away_hostility"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-away-hostility signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_away_hostility insert completed")
