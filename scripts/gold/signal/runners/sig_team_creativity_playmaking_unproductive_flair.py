"""Run the sig_team_creativity_playmaking_unproductive_flair gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_unproductive_flair"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-unproductive-flair signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_unproductive_flair insert completed")
