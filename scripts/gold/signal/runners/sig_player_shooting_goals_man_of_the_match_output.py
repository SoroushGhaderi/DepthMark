"""Run the sig_player_shooting_goals_man_of_the_match_output gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_man_of_the_match_output"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-man-of-the-match-output signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_man_of_the_match_output insert completed")
