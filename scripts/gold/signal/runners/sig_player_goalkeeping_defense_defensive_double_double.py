"""Run the sig_player_goalkeeping_defense_defensive_double_double gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_defensive_double_double"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-defensive-double-double signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_defensive_double_double insert completed")
