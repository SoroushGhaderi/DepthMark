"""Run the sig_match_goalkeeping_defense_offside_frenzy gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_offside_frenzy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-offside-frenzy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_offside_frenzy insert completed")
