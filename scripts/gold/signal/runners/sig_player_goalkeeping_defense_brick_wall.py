"""Run the sig_player_goalkeeping_defense_brick_wall gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_brick_wall"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-brick-wall signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_brick_wall insert completed")
