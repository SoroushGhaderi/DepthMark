"""Run the sig_player_goalkeeping_defense_dribbled_past_heavy gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_dribbled_past_heavy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-dribbled-past-heavy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_dribbled_past_heavy insert completed")
