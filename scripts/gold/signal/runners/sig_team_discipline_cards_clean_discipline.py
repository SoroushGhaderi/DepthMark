"""Run the sig_team_discipline_cards_clean_discipline gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_clean_discipline"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-clean-discipline signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_clean_discipline insert completed")
