"""Run the sig_player_goalkeeping_defense_clean_sheet_locked gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_clean_sheet_locked"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-clean-sheet-locked signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_clean_sheet_locked insert completed")
