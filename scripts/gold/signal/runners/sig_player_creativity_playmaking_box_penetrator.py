"""Run the sig_player_creativity_playmaking_box_penetrator gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_box_penetrator"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-box-penetrator signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_box_penetrator insert completed")
