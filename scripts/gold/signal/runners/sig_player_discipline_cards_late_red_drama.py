"""Run the sig_player_discipline_cards_late_red_drama gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_late_red_drama"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-late-red-drama signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_late_red_drama insert completed")
