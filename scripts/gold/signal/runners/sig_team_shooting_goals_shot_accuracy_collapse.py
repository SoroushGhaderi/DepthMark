"""Run the sig_team_shooting_goals_shot_accuracy_collapse gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_shot_accuracy_collapse"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-shot-accuracy-collapse signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_shot_accuracy_collapse insert completed")
