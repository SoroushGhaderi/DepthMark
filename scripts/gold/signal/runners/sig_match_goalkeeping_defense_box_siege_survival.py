"""Run the sig_match_goalkeeping_defense_box_siege_survival gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_box_siege_survival"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-box-siege-survival signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_box_siege_survival insert completed")
