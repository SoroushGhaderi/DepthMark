"""Run the sig_team_creativity_playmaking_unlikely_creative_source gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_unlikely_creative_source"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-unlikely-creative-source signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_unlikely_creative_source insert completed")
