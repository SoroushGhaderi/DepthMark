"""Run the sig_team_goalkeeping_defense_recovery_dominance gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_recovery_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-recovery-dominance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_recovery_dominance insert completed")
