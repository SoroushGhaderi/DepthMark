"""Run the sig_match_discipline_cards_discipline_dominance gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_discipline_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-discipline-dominance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_discipline_dominance insert completed")
