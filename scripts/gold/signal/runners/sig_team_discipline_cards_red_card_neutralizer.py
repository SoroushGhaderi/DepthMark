"""Run the sig_team_discipline_cards_red_card_neutralizer gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_red_card_neutralizer"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-red-card-neutralizer signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_red_card_neutralizer insert completed")
