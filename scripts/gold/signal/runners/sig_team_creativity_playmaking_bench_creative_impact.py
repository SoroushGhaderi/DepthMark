"""Run the sig_team_creativity_playmaking_bench_creative_impact gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_bench_creative_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-bench-creative-impact signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_bench_creative_impact insert completed")
