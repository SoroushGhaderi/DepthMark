"""Run the sig_player_creativity_playmaking_deadball_wizard gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_deadball_wizard"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-deadball-wizard signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_deadball_wizard insert completed")
