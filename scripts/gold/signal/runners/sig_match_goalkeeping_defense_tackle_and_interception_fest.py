"""Run the sig_match_goalkeeping_defense_tackle_and_interception_fest gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_tackle_and_interception_fest"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-tackle-and-interception-fest signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_tackle_and_interception_fest insert completed")
