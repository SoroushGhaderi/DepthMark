"""Run the sig_player_goalkeeping_defense_keeper_save_efficiency gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_keeper_save_efficiency"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-keeper-save-efficiency signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_keeper_save_efficiency insert completed")
