"""Run the sig_player_creativity_playmaking_unselfish_forward gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_unselfish_forward"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-unselfish-forward signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_unselfish_forward insert completed")
