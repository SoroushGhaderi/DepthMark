"""Run the sig_match_discipline_cards_boiling_over gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_boiling_over"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-boiling-over signal query"
    )
