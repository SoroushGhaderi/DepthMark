"""Run the sig_match_discipline_cards_stop_start_hell gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_stop_start_hell"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-stop-start-hell signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_stop_start_hell insert completed")
