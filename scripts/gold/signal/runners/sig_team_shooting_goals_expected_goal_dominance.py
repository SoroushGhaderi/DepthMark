"""Run the sig_team_shooting_goals_expected_goal_dominance gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_expected_goal_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_expected_goal_dominance signal query"
    )
