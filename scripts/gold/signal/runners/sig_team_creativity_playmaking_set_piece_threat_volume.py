"""Run the sig_team_creativity_playmaking_set_piece_threat_volume gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_set_piece_threat_volume"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-set-piece-threat-volume signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_set_piece_threat_volume insert completed")
