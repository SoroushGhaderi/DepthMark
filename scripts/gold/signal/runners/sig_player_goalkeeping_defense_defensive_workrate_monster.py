"""Run the sig_player_goalkeeping_defense_defensive_workrate_monster gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_defensive_workrate_monster"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-defensive-workrate-monster signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_defensive_workrate_monster insert completed")
