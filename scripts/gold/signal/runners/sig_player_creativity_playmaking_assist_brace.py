"""Run the sig_player_creativity_playmaking_assist_brace gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_assist_brace"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-assist-brace signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_assist_brace insert completed")
