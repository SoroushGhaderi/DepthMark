"""Run the sig_player_discipline_cards_unnecessary_card gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_unnecessary_card"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-unnecessary-card signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_unnecessary_card insert completed")
