"""Run the sig_team_goalkeeping_defense_clean_sheet_efficiency gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_clean_sheet_efficiency"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-clean-sheet-efficiency signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_clean_sheet_efficiency insert completed")
