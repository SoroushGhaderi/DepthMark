"""Run the sig_team_goalkeeping_defense_box_evacuation gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_box_evacuation"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-box-evacuation signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_box_evacuation insert completed")
