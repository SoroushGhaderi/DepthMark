"""Run the sig_match_discipline_cards_foul_parity gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_foul_parity"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-foul-parity signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_foul_parity insert completed")
