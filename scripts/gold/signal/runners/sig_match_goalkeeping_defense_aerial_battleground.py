"""Run the sig_match_goalkeeping_defense_aerial_battleground gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_aerial_battleground"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-aerial-battleground signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_aerial_battleground insert completed")
