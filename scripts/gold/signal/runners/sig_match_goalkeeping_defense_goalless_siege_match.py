"""Run the sig_match_goalkeeping_defense_goalless_siege_match gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_goalless_siege_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-goalless-siege-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_goalless_siege_match insert completed")
