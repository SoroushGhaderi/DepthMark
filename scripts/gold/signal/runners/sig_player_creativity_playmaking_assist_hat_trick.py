"""Run the sig_player_creativity_playmaking_assist_hat_trick gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_assist_hat_trick"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-assist-hat-trick signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_assist_hat_trick insert completed")
