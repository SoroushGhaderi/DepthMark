"""Run the sig_player_creativity_playmaking_maestro_output gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_maestro_output"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-maestro-output signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_maestro_output insert completed")
