"""Run the sig_team_creativity_playmaking_dribbling_exhibition gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_dribbling_exhibition"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-dribbling-exhibition signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_dribbling_exhibition insert completed")
