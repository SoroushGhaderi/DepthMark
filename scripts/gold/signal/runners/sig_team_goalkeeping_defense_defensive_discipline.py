"""Run the sig_team_goalkeeping_defense_defensive_discipline gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_defensive_discipline"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-defensive-discipline signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_defensive_discipline insert completed")
