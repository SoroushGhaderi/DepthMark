"""Run the sig_player_shooting_goals_clutch_brace_winning gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_clutch_brace_winning"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-clutch-brace-winning signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_clutch_brace_winning insert completed")
