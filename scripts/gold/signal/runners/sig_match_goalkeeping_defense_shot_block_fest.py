"""Run the sig_match_goalkeeping_defense_shot_block_fest gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_shot_block_fest"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-shot-block-fest signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_shot_block_fest insert completed")
