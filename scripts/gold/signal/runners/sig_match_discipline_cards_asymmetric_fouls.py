"""Run the sig_match_discipline_cards_asymmetric_fouls gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_asymmetric_fouls"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-asymmetric-fouls signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_asymmetric_fouls insert completed")
