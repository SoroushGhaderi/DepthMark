"""Run the sig_team_discipline_cards_aggression_spike gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_aggression_spike"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-aggression-spike signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_aggression_spike insert completed")
