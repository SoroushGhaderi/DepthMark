"""Run the sig_player_creativity_playmaking_clutch_vision gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_clutch_vision"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-clutch-vision signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_clutch_vision insert completed")
