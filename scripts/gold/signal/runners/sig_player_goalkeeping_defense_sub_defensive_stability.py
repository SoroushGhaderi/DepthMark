"""Run the sig_player_goalkeeping_defense_sub_defensive_stability gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_sub_defensive_stability"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-sub-defensive-stability signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_sub_defensive_stability insert completed")
