"""Run the sig_player_goalkeeping_defense_clearance_machine gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_clearance_machine"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-clearance-machine signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_clearance_machine insert completed")
