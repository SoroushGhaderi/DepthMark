"""Run the sig_team_goalkeeping_defense_defensive_pressure_peak gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_defensive_pressure_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-defensive-pressure-peak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_defensive_pressure_peak insert completed")
