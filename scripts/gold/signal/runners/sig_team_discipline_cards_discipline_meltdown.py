"""Run the sig_team_discipline_cards_discipline_meltdown gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_discipline_meltdown"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-discipline-meltdown signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_discipline_meltdown insert completed")
