"""Run the sig_player_goalkeeping_defense_shot_blocker_elite gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_shot_blocker_elite"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-shot-blocker-elite signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_shot_blocker_elite insert completed")
