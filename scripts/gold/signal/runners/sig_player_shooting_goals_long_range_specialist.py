"""Run the sig_player_shooting_goals_long_range_specialist gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_long_range_specialist"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-long-range-specialist signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_long_range_specialist insert completed")
