"""Run the sig_team_discipline_cards_frustration_peak gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_frustration_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-frustration-peak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_frustration_peak insert completed")
