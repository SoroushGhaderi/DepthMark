"""Run the sig_player_goalkeeping_defense_aerial_stronghold gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_aerial_stronghold"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-aerial-stronghold signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_aerial_stronghold insert completed")
