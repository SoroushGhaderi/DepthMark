"""Run the sig_team_goalkeeping_defense_aerial_fortress gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_aerial_fortress"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-aerial-fortress signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_aerial_fortress insert completed")
