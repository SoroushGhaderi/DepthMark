"""Run the sig_team_discipline_cards_foul_efficiency gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_foul_efficiency"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-foul-efficiency signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_foul_efficiency insert completed")
