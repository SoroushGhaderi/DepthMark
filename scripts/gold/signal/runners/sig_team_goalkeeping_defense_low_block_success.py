"""Run the sig_team_goalkeeping_defense_low_block_success gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_low_block_success"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-low-block-success signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_low_block_success insert completed")
