"""Run the sig_team_creativity_playmaking_unassisted_goals gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_unassisted_goals"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-unassisted-goals signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_unassisted_goals insert completed")
