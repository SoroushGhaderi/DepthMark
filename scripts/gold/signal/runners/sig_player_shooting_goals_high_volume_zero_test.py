"""Run the sig_player_shooting_goals_high_volume_zero_test gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_high_volume_zero_test"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-high-volume-zero-test signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_high_volume_zero_test insert completed")
