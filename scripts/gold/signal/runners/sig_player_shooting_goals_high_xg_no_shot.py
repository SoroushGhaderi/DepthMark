"""Run the sig_player_shooting_goals_high_xg_no_shot gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_high_xg_no_shot"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-high-xg-no-shot signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_high_xg_no_shot insert completed")
