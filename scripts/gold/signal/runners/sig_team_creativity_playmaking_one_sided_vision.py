"""Run the sig_team_creativity_playmaking_one_sided_vision gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_one_sided_vision"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-one-sided-vision signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_one_sided_vision insert completed")
