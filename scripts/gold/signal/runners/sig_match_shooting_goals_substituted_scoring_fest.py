"""Run the sig_match_shooting_goals_substituted_scoring_fest gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_substituted_scoring_fest"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-substituted-scoring-fest signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_substituted_scoring_fest insert completed")
