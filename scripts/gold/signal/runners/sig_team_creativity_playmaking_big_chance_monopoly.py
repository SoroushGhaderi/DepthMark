"""Run the sig_team_creativity_playmaking_big_chance_monopoly gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_big_chance_monopoly"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-big-chance-monopoly signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_big_chance_monopoly insert completed")
