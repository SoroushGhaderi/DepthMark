"""Run the sig_team_goalkeeping_defense_keeper_reliance_index gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_keeper_reliance_index"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-keeper-reliance-index signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_keeper_reliance_index insert completed")
