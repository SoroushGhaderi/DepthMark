"""Run the sig_player_discipline_cards_penalty_conceder gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_penalty_conceder"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-penalty-conceder signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_penalty_conceder insert completed")
