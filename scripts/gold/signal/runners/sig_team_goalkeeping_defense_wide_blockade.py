"""Run the sig_team_goalkeeping_defense_wide_blockade gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_wide_blockade"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-wide-blockade signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_wide_blockade insert completed")
