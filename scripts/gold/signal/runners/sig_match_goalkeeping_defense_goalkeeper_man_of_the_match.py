"""Run the sig_match_goalkeeping_defense_goalkeeper_man_of_the_match gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_goalkeeper_man_of_the_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-goalkeeper-man-of-the-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_goalkeeper_man_of_the_match insert completed")
