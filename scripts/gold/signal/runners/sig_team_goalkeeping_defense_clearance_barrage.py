"""Run the sig_team_goalkeeping_defense_clearance_barrage gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_clearance_barrage"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-clearance-barrage signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_clearance_barrage insert completed")
