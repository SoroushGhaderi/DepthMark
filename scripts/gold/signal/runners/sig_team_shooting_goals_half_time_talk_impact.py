"""Run the sig_team_shooting_goals_half_time_talk_impact gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_half_time_talk_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-half-time-talk-impact signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_half_time_talk_impact insert completed")
