"""Run the sig_player_goalkeeping_defense_pressure_absorber gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_pressure_absorber"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-pressure-absorber signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_pressure_absorber insert completed")
