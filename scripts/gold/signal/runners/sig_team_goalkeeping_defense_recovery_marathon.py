"""Run the sig_team_goalkeeping_defense_recovery_marathon gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_recovery_marathon"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-recovery-marathon signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_recovery_marathon insert completed")
