"""Run the sig_player_creativity_playmaking_isolated_creativity gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_isolated_creativity"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-isolated-creativity signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_isolated_creativity insert completed")
