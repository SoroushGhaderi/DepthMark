"""Run the sig_player_creativity_playmaking_cross_perfection gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_cross_perfection"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-cross-perfection signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_cross_perfection insert completed")
