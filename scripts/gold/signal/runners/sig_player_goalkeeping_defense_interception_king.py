"""Run the sig_player_goalkeeping_defense_interception_king gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_interception_king"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-interception-king signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_interception_king insert completed")
