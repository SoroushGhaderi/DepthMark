"""Run the sig_match_discipline_cards_asymmetric_aggression gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_asymmetric_aggression"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-asymmetric-aggression signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_asymmetric_aggression insert completed")
