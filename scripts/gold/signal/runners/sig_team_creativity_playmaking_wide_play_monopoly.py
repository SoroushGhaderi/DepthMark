"""Run the sig_team_creativity_playmaking_wide_play_monopoly gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_wide_play_monopoly"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-wide-play-monopoly signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_wide_play_monopoly insert completed")
