"""Run the sig_player_discipline_cards_heavy_hitter gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_heavy_hitter"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-heavy-hitter signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_heavy_hitter insert completed")
