"""Run the sig_match_shooting_goals_box_siege_match gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_box_siege_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_match_shooting_goals_box_siege_match signal query"
    )
