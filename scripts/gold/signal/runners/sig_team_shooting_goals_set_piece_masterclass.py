"""Run the sig_team_shooting_goals_set_piece_masterclass gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_set_piece_masterclass"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-set-piece-masterclass signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_set_piece_masterclass insert completed")
