"""Run the sig_player_discipline_cards_captain_reprimand gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_captain_reprimand"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-captain-reprimand signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_captain_reprimand insert completed")
