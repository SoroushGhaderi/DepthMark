"""Run the sig_team_goalkeeping_defense_tackle_volume_surge gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_tackle_volume_surge"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-tackle-volume-surge signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_tackle_volume_surge insert completed")
