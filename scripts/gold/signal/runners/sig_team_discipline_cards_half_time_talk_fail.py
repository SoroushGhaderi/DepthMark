"""Run the sig_team_discipline_cards_half_time_talk_fail gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_half_time_talk_fail"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-half-time-talk-fail signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_half_time_talk_fail insert completed")
