"""Run the sig_player_creativity_playmaking_box_to_box_playmaker gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_box_to_box_playmaker"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-box-to-box-playmaker signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_box_to_box_playmaker insert completed")
