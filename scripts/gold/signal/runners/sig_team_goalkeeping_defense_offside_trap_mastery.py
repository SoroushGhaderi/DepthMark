"""Run the sig_team_goalkeeping_defense_offside_trap_mastery gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_offside_trap_mastery"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-offside-trap-mastery signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_offside_trap_mastery insert completed")
