"""Run the sig_player_creativity_playmaking_high_value_turnover gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_high_value_turnover"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-high-value-turnover signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_high_value_turnover insert completed")
