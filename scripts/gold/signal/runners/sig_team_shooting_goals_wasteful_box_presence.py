"""Run the sig_team_shooting_goals_wasteful_box_presence gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_wasteful_box_presence"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_wasteful_box_presence signal query"
    )
