"""Run the sig_team_shooting_goals_late_game_salvage gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_late_game_salvage"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-late-game-salvage signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_late_game_salvage insert completed")
