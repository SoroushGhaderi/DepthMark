"""Run the sig_team_shooting_goals_big_chance_efficiency gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_big_chance_efficiency"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_big_chance_efficiency signal query"
    )
