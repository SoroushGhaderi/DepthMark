"""Run the sig_match_shooting_goals_woodwork_record_match gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_woodwork_record_match"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-woodwork-record-match signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_woodwork_record_match insert completed")
