"""Run the sig_player_creativity_playmaking_fullback_playmaker gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_fullback_playmaker"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-fullback-playmaker signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_fullback_playmaker insert completed")
