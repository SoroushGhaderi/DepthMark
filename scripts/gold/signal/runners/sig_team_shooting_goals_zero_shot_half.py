"""Run the sig_team_shooting_goals_zero_shot_half gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_zero_shot_half"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-zero-shot-half signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_zero_shot_half insert completed")
