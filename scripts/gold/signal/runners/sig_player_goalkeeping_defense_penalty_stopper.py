"""Run the sig_player_goalkeeping_defense_penalty_stopper gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_penalty_stopper"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-penalty-stopper signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_penalty_stopper insert completed")
