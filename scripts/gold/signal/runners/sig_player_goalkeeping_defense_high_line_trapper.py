"""Run the sig_player_goalkeeping_defense_high_line_trapper gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_high_line_trapper"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-high-line-trapper signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_high_line_trapper insert completed")
