"""Run the sig_player_creativity_playmaking_the_quarterback gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_the_quarterback"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-the-quarterback signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_the_quarterback insert completed")
