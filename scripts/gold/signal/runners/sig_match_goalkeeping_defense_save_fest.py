"""Run the sig_match_goalkeeping_defense_save_fest gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_save_fest"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-save-fest signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_save_fest insert completed")
