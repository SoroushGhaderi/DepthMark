"""Run the sig_team_discipline_cards_systematic_fouling gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_systematic_fouling"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-systematic-fouling signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_systematic_fouling insert completed")
