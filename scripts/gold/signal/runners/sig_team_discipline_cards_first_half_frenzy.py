"""Run the sig_team_discipline_cards_first_half_frenzy gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_first_half_frenzy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-first-half-frenzy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_first_half_frenzy insert completed")
