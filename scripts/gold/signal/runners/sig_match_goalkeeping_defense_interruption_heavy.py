"""Run the sig_match_goalkeeping_defense_interruption_heavy gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_interruption_heavy"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-interruption-heavy signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_interruption_heavy insert completed")
