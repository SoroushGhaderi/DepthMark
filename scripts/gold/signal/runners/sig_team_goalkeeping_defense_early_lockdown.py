"""Run the sig_team_goalkeeping_defense_early_lockdown gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_early_lockdown"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-early-lockdown signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_early_lockdown insert completed")
