"""Run the sig_team_shooting_goals_efficiency_peak gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_efficiency_peak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the sig_team_shooting_goals_efficiency_peak signal query")
