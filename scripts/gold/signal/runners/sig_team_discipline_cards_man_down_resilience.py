"""Run the sig_team_discipline_cards_man_down_resilience gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_man_down_resilience"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-man-down-resilience signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_man_down_resilience insert completed")
