"""Run the sig_team_creativity_playmaking_crossing_clinic gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_crossing_clinic"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-crossing-clinic signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_crossing_clinic insert completed")
