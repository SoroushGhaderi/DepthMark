"""Run the sig_team_discipline_cards_collective_aggression gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_collective_aggression"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-collective-aggression signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_collective_aggression insert completed")
