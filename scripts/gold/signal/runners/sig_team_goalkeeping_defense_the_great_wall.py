"""Run the sig_team_goalkeeping_defense_the_great_wall gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_the_great_wall"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-the-great-wall signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_the_great_wall insert completed")
