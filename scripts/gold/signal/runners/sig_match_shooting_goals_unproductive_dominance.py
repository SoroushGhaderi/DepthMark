"""Run the sig_match_shooting_goals_unproductive_dominance gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_unproductive_dominance"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-unproductive-dominance signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_unproductive_dominance insert completed")
