"""Run the sig_team_discipline_cards_early_warning gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_early_warning"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-early-warning signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_early_warning insert completed")
