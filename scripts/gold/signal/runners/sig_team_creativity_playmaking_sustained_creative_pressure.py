"""Run the sig_team_creativity_playmaking_sustained_creative_pressure gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_sustained_creative_pressure"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-sustained-creative-pressure signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_sustained_creative_pressure insert completed")
