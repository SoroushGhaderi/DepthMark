"""Run the sig_match_creativity_playmaking_the_creativity_clash gold query."""
...
TARGET_TABLE = "gold.sig_match_creativity_playmaking_the_creativity_clash"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-creativity-playmaking-the-creativity-clash signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_creativity_playmaking_the_creativity_clash insert completed")
