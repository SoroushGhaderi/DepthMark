"""Run the sig_team_creativity_playmaking_final_third_siege gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_final_third_siege"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-final-third-siege signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_final_third_siege insert completed")
