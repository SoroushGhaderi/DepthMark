"""Run the sig_match_discipline_cards_card_heavy_substitutions gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_card_heavy_substitutions"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the sig_match_discipline_cards_card_heavy_substitutions signal query")
