"""Run the sig_player_shooting_goals_big_chance_bottler gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_big_chance_bottler"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-big-chance-bottler signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_big_chance_bottler insert completed")
