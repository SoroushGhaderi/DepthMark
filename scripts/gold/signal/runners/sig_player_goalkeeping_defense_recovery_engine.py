"""Run the sig_player_goalkeeping_defense_recovery_engine gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_recovery_engine"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-recovery-engine signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_recovery_engine insert completed")
