"""Run the sig_match_discipline_cards_physical_showdown gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_physical_showdown"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-physical-showdown signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_physical_showdown insert completed")
