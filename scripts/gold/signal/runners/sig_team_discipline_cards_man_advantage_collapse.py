"""Run the sig_team_discipline_cards_man_advantage_collapse gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_man_advantage_collapse"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-man-advantage-collapse signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_man_advantage_collapse insert completed")
