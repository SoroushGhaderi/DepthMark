"""Run the sig_team_creativity_playmaking_midfield_engine_vision gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_midfield_engine_vision"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-midfield-engine-vision signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_midfield_engine_vision insert completed")
