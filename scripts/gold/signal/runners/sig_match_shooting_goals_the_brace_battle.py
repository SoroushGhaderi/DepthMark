"""Run the sig_match_shooting_goals_the_brace_battle gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_the_brace_battle"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_match_shooting_goals_the_brace_battle signal query"
    )
