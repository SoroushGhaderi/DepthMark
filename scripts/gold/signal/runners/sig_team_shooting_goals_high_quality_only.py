"""Run the sig_team_shooting_goals_high_quality_only gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_high_quality_only"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the sig_team_shooting_goals_high_quality_only signal query"
    )
