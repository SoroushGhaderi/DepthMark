"""Run the sig_player_creativity_playmaking_final_third_monopoly gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_final_third_monopoly"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-final-third-monopoly signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_final_third_monopoly insert completed")
