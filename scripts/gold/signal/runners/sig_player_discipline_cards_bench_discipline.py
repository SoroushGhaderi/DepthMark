"""Run the sig_player_discipline_cards_bench_discipline gold query."""
...
TARGET_TABLE = "gold.sig_player_discipline_cards_bench_discipline"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-discipline-cards-bench-discipline signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_discipline_cards_bench_discipline insert completed")
