"""Run the sig_team_discipline_cards_aggression_drop_off gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_aggression_drop_off"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-aggression-drop-off signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_aggression_drop_off insert completed")
