"""Run the sig_player_goalkeeping_defense_no_fouls_defending gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_no_fouls_defending"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-no-fouls-defending signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_no_fouls_defending insert completed")
