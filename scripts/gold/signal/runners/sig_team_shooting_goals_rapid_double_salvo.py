"""Run the sig_team_shooting_goals_rapid_double_salvo gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_rapid_double_salvo"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-rapid-double-salvo signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_rapid_double_salvo insert completed")
