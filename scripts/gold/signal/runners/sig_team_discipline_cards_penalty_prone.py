"""Run the sig_team_discipline_cards_penalty_prone gold query."""
...
TARGET_TABLE = "gold.sig_team_discipline_cards_penalty_prone"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-discipline-cards-penalty-prone signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_discipline_cards_penalty_prone insert completed")
