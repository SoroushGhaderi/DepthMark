"""Run the sig_player_shooting_goals_hat_trick_hero gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_hat_trick_hero"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the player-shooting-goals-hat-trick-hero signal query")
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_hat_trick_hero insert completed")
