"""Run the sig_player_goalkeeping_defense_reflex_save_streak gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_reflex_save_streak"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-reflex-save-streak signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_reflex_save_streak insert completed")
