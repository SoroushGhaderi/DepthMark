"""Run the sig_team_goalkeeping_defense_parking_the_bus gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_parking_the_bus"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-parking-the-bus signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_parking_the_bus insert completed")
