"""Run the sig_player_goalkeeping_defense_clean_sheet_contributor gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_clean_sheet_contributor"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-clean-sheet-contributor signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_clean_sheet_contributor insert completed")
