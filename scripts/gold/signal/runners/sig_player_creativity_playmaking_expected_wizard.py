"""Run the sig_player_creativity_playmaking_expected_wizard gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_expected_wizard"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-expected-wizard signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_expected_wizard insert completed")
