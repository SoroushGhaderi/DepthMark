"""Run the sig_player_creativity_playmaking_chance_machine gold query."""
...
TARGET_TABLE = "gold.sig_player_creativity_playmaking_chance_machine"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-creativity-playmaking-chance-machine signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_creativity_playmaking_chance_machine insert completed")
