"""Run the sig_team_goalkeeping_defense_unbroken_structure gold query."""
...
TARGET_TABLE = "gold.sig_team_goalkeeping_defense_unbroken_structure"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-goalkeeping-defense-unbroken-structure signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_goalkeeping_defense_unbroken_structure insert completed")
