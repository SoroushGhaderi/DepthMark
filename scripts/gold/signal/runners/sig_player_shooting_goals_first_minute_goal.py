"""Run the sig_player_shooting_goals_first_minute_goal gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_first_minute_goal"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-first-minute-goal signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_first_minute_goal insert completed")
