"""Run the sig_team_shooting_goals_clinical_bench_impact gold query."""
...
TARGET_TABLE = "gold.sig_team_shooting_goals_clinical_bench_impact"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-shooting-goals-clinical-bench-impact signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_shooting_goals_clinical_bench_impact insert completed")
