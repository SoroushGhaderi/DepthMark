"""Run the sig_match_discipline_cards_chaos_90_plus gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_chaos_90_plus"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-chaos-90-plus signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_chaos_90_plus insert completed")
