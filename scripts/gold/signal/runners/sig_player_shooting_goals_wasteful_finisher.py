"""Run the sig_player_shooting_goals_wasteful_finisher gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_wasteful_finisher"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-wasteful-finisher signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_wasteful_finisher insert completed")
