"""Run the sig_match_goalkeeping_defense_keeper_masterclass_duel gold query."""
...
TARGET_TABLE = "gold.sig_match_goalkeeping_defense_keeper_masterclass_duel"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-goalkeeping-defense-keeper-masterclass-duel signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_goalkeeping_defense_keeper_masterclass_duel insert completed")
