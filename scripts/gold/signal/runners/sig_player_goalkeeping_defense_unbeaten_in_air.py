"""Run the sig_player_goalkeeping_defense_unbeaten_in_air gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_unbeaten_in_air"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-unbeaten-in-air signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_unbeaten_in_air insert completed")
