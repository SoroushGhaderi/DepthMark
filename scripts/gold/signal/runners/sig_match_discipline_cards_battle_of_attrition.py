"""Run the sig_match_discipline_cards_battle_of_attrition gold query."""
...
TARGET_TABLE = "gold.sig_match_discipline_cards_battle_of_attrition"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-discipline-cards-battle-of-attrition signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_discipline_cards_battle_of_attrition insert completed")
