"""Run the sig_match_shooting_goals_distance_shooting_duel gold query."""
...
TARGET_TABLE = "gold.sig_match_shooting_goals_distance_shooting_duel"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the match-shooting-goals-distance-shooting-duel signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_match_shooting_goals_distance_shooting_duel insert completed")
