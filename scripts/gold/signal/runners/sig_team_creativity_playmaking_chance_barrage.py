"""Run the sig_team_creativity_playmaking_chance_barrage gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_chance_barrage"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-chance-barrage signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_chance_barrage insert completed")
