"""Run the sig_player_goalkeeping_defense_passive_defender gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_passive_defender"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-passive-defender signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_passive_defender insert completed")
