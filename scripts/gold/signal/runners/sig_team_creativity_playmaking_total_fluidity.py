"""Run the sig_team_creativity_playmaking_total_fluidity gold query."""
...
TARGET_TABLE = "gold.sig_team_creativity_playmaking_total_fluidity"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the team-creativity-playmaking-total-fluidity signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_team_creativity_playmaking_total_fluidity insert completed")
