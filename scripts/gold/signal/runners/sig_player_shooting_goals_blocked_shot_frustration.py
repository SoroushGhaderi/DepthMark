"""Run the sig_player_shooting_goals_blocked_shot_frustration gold query."""
...
TARGET_TABLE = "gold.sig_player_shooting_goals_blocked_shot_frustration"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-shooting-goals-blocked-shot-frustration signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_shooting_goals_blocked_shot_frustration insert completed")
