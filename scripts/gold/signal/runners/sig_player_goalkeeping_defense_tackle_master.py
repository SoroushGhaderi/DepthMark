"""Run the sig_player_goalkeeping_defense_tackle_master gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_tackle_master"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-tackle-master signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_tackle_master insert completed")
