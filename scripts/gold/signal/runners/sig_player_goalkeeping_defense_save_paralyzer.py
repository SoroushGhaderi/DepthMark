"""Run the sig_player_goalkeeping_defense_save_paralyzer gold query."""
...
TARGET_TABLE = "gold.sig_player_goalkeeping_defense_save_paralyzer"


def parse_args(argv=None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the player-goalkeeping-defense-save-paralyzer signal query"
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        logger.info("sig_player_goalkeeping_defense_save_paralyzer insert completed")
