INSERT INTO gold.sig_player_creativity_playmaking_expected_wizard (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_creativity_playmaking_expected_wizard
-- Trigger: player records expected assists (xA) >= 1.0 with 0 actual assists.
-- Intent: identify high-quality playmakers whose chance creation output was not converted into official assists,
--         while preserving bilateral team control and territory context.
...
SELECT
    ...
    toFloat32(1.0) AS trigger_threshold_min_expected_assists,
    ...
    toFloat32(round(coalesce(p.expected_assists, 0.0) - 1.0, 3)) AS expected_assists_above_threshold,
