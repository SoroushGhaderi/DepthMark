...
SELECT
    ...
    toInt32(recovery_pivot.home_team_recoveries - 60) AS triggered_team_recoveries_above_threshold,
...
WHERE m.match_finished = 1
  AND m.match_id > 0
  AND recovery_pivot.home_team_recoveries >= 60
...
SELECT
    ...
    toInt32(recovery_pivot.away_team_recoveries - 60) AS triggered_team_recoveries_above_threshold,
...
WHERE m.match_finished = 1
  AND m.match_id > 0
  AND recovery_pivot.away_team_recoveries >= 60
