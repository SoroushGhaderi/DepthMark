INSERT INTO gold.sig_team_discipline_cards_collective_aggression (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_team_discipline_cards_collective_aggression
-- Trigger: team commits >= 20 fouls in a single match.
-- Intent: detect team-level collective aggression with bilateral discipline and defensive-intensity context.
