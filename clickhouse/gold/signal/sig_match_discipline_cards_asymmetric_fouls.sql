INSERT INTO gold.sig_match_discipline_cards_asymmetric_fouls (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_triggered_team_fouls_share_pct,
    ...
    triggered_team_fouls_share_above_threshold_pct,
...
-- Signal: sig_match_discipline_cards_asymmetric_fouls
-- Intent: detect match-level foul asymmetry where one side drives the majority of whistle events.
-- Trigger: one team has >= 70% of total match fouls at period='All'.
WITH base_stats AS (
    SELECT
        m.match_id,
        m.match_date,
...
SELECT
    ...
    toFloat32(70.0) AS trigger_threshold_min_triggered_team_fouls_share_pct,
    ...
    toFloat32(round(
        ...
        1
    )) AS triggered_team_fouls_share_above_threshold_pct,
...
ORDER BY
    triggered_team_fouls_share_pct DESC,
