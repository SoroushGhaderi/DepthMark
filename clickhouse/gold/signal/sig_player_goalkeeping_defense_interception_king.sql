INSERT INTO gold.sig_player_goalkeeping_defense_interception_king (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_goalkeeping_defense_interception_king
-- Intent: detect defender performances with elite interception volume and preserve bilateral defensive context.
-- Trigger: player records at least 7 interceptions in a finished match.
SELECT
    m.match_id,
    m.match_date,
    m.home_team_id,
    ...
    toInt32(7) AS trigger_threshold_min_interceptions,
    toInt32(coalesce(p.interceptions, 0)) AS triggered_player_interceptions,
    toInt32(coalesce(p.interceptions, 0) - 7) AS triggered_player_interceptions_above_threshold,
