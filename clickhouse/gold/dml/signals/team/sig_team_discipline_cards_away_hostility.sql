INSERT INTO gold.sig_team_discipline_cards_away_hostility (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_team_discipline_cards_away_hostility
-- Trigger: away team receives >= 4 more total cards than home team.
-- Intent: surface away-side discipline hostility versus the host while preserving bilateral card, foul, and game-control context.
...
SELECT
    ...
    toInt32(4) AS trigger_threshold_min_card_count_delta,
