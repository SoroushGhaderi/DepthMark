INSERT INTO gold.sig_team_shooting_goals_half_time_talk_impact (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_goals_first_10_second_half,
    trigger_threshold_second_half_window_start_minute,
    trigger_threshold_second_half_window_end_minute,
    triggered_team_goals_first_10_second_half,
    opponent_goals_first_10_second_half,
    goals_first_10_second_half_delta,
    triggered_team_first_goal_minute_first_10_second_half,
    triggered_team_first_goal_added_time_first_10_second_half,
    triggered_team_first_goal_effective_minute_first_10_second_half,
    triggered_team_second_goal_minute_first_10_second_half,
    triggered_team_second_goal_added_time_first_10_second_half,
    triggered_team_second_goal_effective_minute_first_10_second_half,
    minutes_between_first_two_goals_first_10_second_half,
    triggered_team_goals_first_10_second_half_above_threshold,
...
-- Signal: sig_team_shooting_goals_half_time_talk_impact
-- Trigger: Team scores at least 2 non-own goals within the first 10 minutes of the second half.
-- Intent: Detect explosive post-halftime scoring bursts and preserve bilateral match context for shot quality,
...
second_half_opening_goal_events AS (
    SELECT
        ge.match_id,
        ge.goal_side,
        ge.goal_minute,
    ...
    WHERE ge.goal_minute BETWEEN 46 AND 55
),
second_half_opening_goal_counts AS (
    SELECT
        ege.match_id,
        ege.goal_side,
        count() AS goals_first_10_second_half
    FROM second_half_opening_goal_events AS ege
    GROUP BY
        ege.match_id,
        ege.goal_side
),
second_half_opening_goal_rollup_base AS (
    SELECT
        ege.match_id,
        ege.goal_side AS triggered_side,
        count() AS triggered_team_goals_first_10_second_half,
...
second_half_opening_goal_rollup AS (
    SELECT
        egrb.match_id,
        egrb.triggered_side,
        toInt32(egrb.triggered_team_goals_first_10_second_half) AS triggered_team_goals_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 1), 2))
            AS triggered_team_first_goal_minute_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 1), 3))
            AS triggered_team_first_goal_added_time_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 1), 1))
            AS triggered_team_first_goal_effective_minute_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 2), 2))
            AS triggered_team_second_goal_minute_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 2), 3))
            AS triggered_team_second_goal_added_time_first_10_second_half,
        toInt32(tupleElement(arrayElement(egrb.ordered_goal_tuples, 2), 1))
            AS triggered_team_second_goal_effective_minute_first_10_second_half,
        toInt32(
            tupleElement(arrayElement(egrb.ordered_goal_tuples, 2), 1)
            - tupleElement(arrayElement(egrb.ordered_goal_tuples, 1), 1)
        ) AS minutes_between_first_two_goals_first_10_second_half
    FROM second_half_opening_goal_rollup_base AS egrb
)
SELECT
    m.match_id,
    m.match_date,
    ...
    toInt32(2) AS trigger_threshold_min_goals_first_10_second_half,
    toInt32(46) AS trigger_threshold_second_half_window_start_minute,
    toInt32(55) AS trigger_threshold_second_half_window_end_minute,
    egr.triggered_team_goals_first_10_second_half,
    toInt32(coalesce(ogc.goals_first_10_second_half, 0)) AS opponent_goals_first_10_second_half,
    toInt32(egr.triggered_team_goals_first_10_second_half - coalesce(ogc.goals_first_10_second_half, 0)) AS goals_first_10_second_half_delta,
    egr.triggered_team_first_goal_minute_first_10_second_half,
    egr.triggered_team_first_goal_added_time_first_10_second_half,
    egr.triggered_team_first_goal_effective_minute_first_10_second_half,
    egr.triggered_team_second_goal_minute_first_10_second_half,
    egr.triggered_team_second_goal_added_time_first_10_second_half,
    egr.triggered_team_second_goal_effective_minute_first_10_second_half,
    egr.minutes_between_first_two_goals_first_10_second_half,
    toInt32(egr.triggered_team_goals_first_10_second_half - 2) AS triggered_team_goals_first_10_second_half_above_threshold,
...
FROM second_half_opening_goal_rollup AS egr
...
INNER JOIN silver.period_stat AS ps
   ...
   AND ps.period = 'All'
LEFT JOIN second_half_opening_goal_counts AS ogc
...
ORDER BY
    egr.triggered_team_goals_first_10_second_half DESC,
    egr.minutes_between_first_two_goals_first_10_second_half ASC,
    m.match_date DESC,
    m.match_id DESC;
