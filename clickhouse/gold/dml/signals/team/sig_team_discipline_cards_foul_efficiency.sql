INSERT INTO gold.sig_team_discipline_cards_foul_efficiency (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_team_discipline_cards_foul_efficiency
-- Trigger: team commits >= 15 fouls and receives 0 total cards (yellow + red) in a single match.
-- Intent: surface high-foul team displays with zero card punishment and preserve bilateral discipline context.
