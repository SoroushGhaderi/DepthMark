INSERT INTO gold.sig_match_goalkeeping_defense_tackle_and_interception_fest (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_combined_tackles_and_interceptions,
    match_total_tackles_and_interceptions,
    match_total_tackles_and_interceptions_above_threshold,
    triggered_team_tackles_and_interceptions,
    opponent_tackles_and_interceptions,
    tackles_and_interceptions_delta,
    triggered_team_tackles_and_interceptions_share_pct,
    opponent_tackles_and_interceptions_share_pct,
    tackles_and_interceptions_share_delta_pct,
...
-- Signal: sig_match_goalkeeping_defense_tackle_and_interception_fest
-- Intent: detect finished matches with elite combined tackle and interception volume,
--         preserving bilateral defensive, control, and outcome context.
-- Trigger: combined match tackles won plus interceptions (home + away) > 80 at period='All'.
WITH base_stats AS (
    SELECT
        m.match_id,
        m.match_date,
        ...
        coalesce(ps.tackles_succeeded_home, 0) + coalesce(ps.interceptions_home, 0)
            AS home_tackles_and_interceptions,
        coalesce(ps.tackles_succeeded_away, 0) + coalesce(ps.interceptions_away, 0)
            AS away_tackles_and_interceptions,
        coalesce(ps.tackles_succeeded_home, 0)
          ...
          + coalesce(ps.interceptions_away, 0)
            AS match_total_tackles_and_interceptions
...
SELECT
    ...
    toInt32(80) AS trigger_threshold_min_combined_tackles_and_interceptions,
    toInt32(b.match_total_tackles_and_interceptions) AS match_total_tackles_and_interceptions,
    toInt32(
        b.match_total_tackles_and_interceptions - 80
    ) AS match_total_tackles_and_interceptions_above_threshold,
    toInt32(b.home_tackles_and_interceptions) AS triggered_team_tackles_and_interceptions,
    toInt32(b.away_tackles_and_interceptions) AS opponent_tackles_and_interceptions,
    toInt32(
        b.home_tackles_and_interceptions - b.away_tackles_and_interceptions
    ) AS tackles_and_interceptions_delta,
    toFloat32(round(
        100.0 * b.home_tackles_and_interceptions
        / nullIf(toFloat64(b.match_total_tackles_and_interceptions), 0),
        1
    )) AS triggered_team_tackles_and_interceptions_share_pct,
    toFloat32(round(
        100.0 * b.away_tackles_and_interceptions
        / nullIf(toFloat64(b.match_total_tackles_and_interceptions), 0),
        1
    )) AS opponent_tackles_and_interceptions_share_pct,
    toFloat32(round(
        (
            100.0 * b.home_tackles_and_interceptions
            / nullIf(toFloat64(b.match_total_tackles_and_interceptions), 0)
        ...
        1
    )) AS tackles_and_interceptions_share_delta_pct,
    ...
    toInt32(
        b.shots_on_target_away - b.shots_on_target_home
    ...
    toFloat32(round(
        b.pass_accuracy_home_pct - b.pass_accuracy_away_pct,
        1
...
SELECT
    ...
    toInt32(b.away_tackles_and_interceptions) AS triggered_team_tackles_and_interceptions,
    toInt32(b.home_tackles_and_interceptions) AS opponent_tackles_and_interceptions,
    toInt32(
        b.away_tackles_and_interceptions - b.home_tackles_and_interceptions
    ) AS tackles_and_interceptions_delta,
    toFloat32(round(
        100.0 * b.away_tackles_and_interceptions
        / nullIf(toFloat64(b.match_total_tackles_and_interceptions), 0),
    ...
    toInt32(
        b.shots_on_target_home - b.shots_on_target_away
    ) AS shots_on_target_faced_delta,
    ...
    toFloat32(round(
        b.pass_accuracy_away_pct - b.pass_accuracy_home_pct,
        1
    )) AS pass_accuracy_delta_pct,
