INSERT INTO gold.sig_match_creativity_playmaking_zero_flair_stalemate (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    trigger_threshold_match_combined_successful_dribbles,
    match_total_goals,
...
base_stats AS (
    ...
    WHERE m.match_finished = 1
      ...
      AND (coalesce(ps.dribbles_succeeded_home, 0) + coalesce(ps.dribbles_succeeded_away, 0)) = 0
)
-- Signal: sig_match_creativity_playmaking_zero_flair_stalemate
-- Trigger: 0-0 draw with 0 combined successful dribbles.
-- Intent: isolate creativity-stalemate matches where teams fail to complete any dribble despite full-match play.
SELECT
    b.match_id,
    b.match_date,
    b.home_team_id,
    ...
    toInt32(0) AS trigger_threshold_match_combined_successful_dribbles,
    b.match_total_goals,
