INSERT INTO gold.sig_match_creativity_playmaking_dribbling_battle (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_combined_successful_dribbles,
...
-- Signal: sig_match_creativity_playmaking_dribbling_battle
-- Trigger: Combined match successful dribbles exceed 40 in a finished match.
-- Intent: capture bilateral high-dribble matches and preserve playmaking, execution, and territorial context.
SELECT
    b.match_id,
    b.match_date,
    b.home_team_id,
    ...
    toInt32(40) AS trigger_threshold_combined_successful_dribbles,
...
FROM base_stats AS b
ORDER BY
    assumeNotNull(match_combined_successful_dribbles) DESC,
    assumeNotNull(triggered_team_successful_dribbles) DESC,
    match_date DESC,
    match_id DESC;
