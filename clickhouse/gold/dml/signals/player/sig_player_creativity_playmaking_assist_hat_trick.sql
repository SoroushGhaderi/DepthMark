INSERT INTO gold.sig_player_creativity_playmaking_assist_hat_trick (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
...
-- Signal: sig_player_creativity_playmaking_assist_hat_trick
...
SELECT
    ...
    toInt32(3) AS trigger_threshold_min_assists,
    toInt32(coalesce(p.assists, 0)) AS triggered_player_assists,
    toInt32(coalesce(p.assists, 0) - 3) AS triggered_player_assists_above_threshold,
