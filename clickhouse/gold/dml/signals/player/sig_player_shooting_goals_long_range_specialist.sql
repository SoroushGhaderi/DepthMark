INSERT INTO gold.sig_player_shooting_goals_long_range_specialist (
    match_id,
    match_date,
    home_team_id,
    home_team_name,
    ...
    opponent_team_id,
    opponent_team_name,
    trigger_threshold_min_outside_box_goals,
    ...
    outside_box_goals_above_threshold,
...
-- Signal: sig_player_shooting_goals_long_range_specialist
-- Trigger: player scores >= 1 goal from shots outside the 18-yard box in a finished match.
-- Intent: isolate long-range scoring specialists using shot-level location evidence while preserving
...
SELECT
    ...
    toInt32(1) AS trigger_threshold_min_outside_box_goals,
    ...
    toInt32(os.triggered_player_outside_box_goals - 1) AS outside_box_goals_above_threshold,
    toFloat32(coalesce(
        round(
            100.0 * os.triggered_player_outside_box_goals
...
ORDER BY
    os.triggered_player_outside_box_goals DESC,
    triggered_player_goal_minus_outside_box_expected_goals DESC,
