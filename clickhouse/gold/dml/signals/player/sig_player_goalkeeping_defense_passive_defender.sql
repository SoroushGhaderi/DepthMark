INSERT INTO gold.sig_player_goalkeeping_defense_passive_defender (
    ...
    trigger_threshold_exact_minutes_played,
    trigger_threshold_max_tackles_won,
    trigger_threshold_max_interceptions,
...
-- Trigger: defender plays 90 minutes with 0 tackles won and 0 interceptions while team possession is 45% or lower.
SELECT
    m.match_id,
    m.match_date,
    m.home_team_id,
    ...
    toInt32(90) AS trigger_threshold_exact_minutes_played,
    toInt32(0) AS trigger_threshold_max_tackles_won,
    toInt32(0) AS trigger_threshold_max_interceptions,
    toFloat32(45.0) AS trigger_threshold_max_possession_pct,
...
WHERE m.match_finished = 1
  ...
  AND coalesce(p.interceptions, 0) = 0
  AND multiIf(
      p.team_id = m.home_team_id, coalesce(ps.ball_possession_home, 0),
      p.team_id = m.away_team_id, coalesce(ps.ball_possession_away, 0),
      0
