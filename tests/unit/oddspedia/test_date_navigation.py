...
from src.oddspedia.match_collector import _navigate_to_date, collect_match_links
...
class CollectMatchLinksDateTests(unittest.TestCase):
    ...
    @patch("src.oddspedia.match_collector._navigate_to_date", return_value=False)
    ...
    @patch("src.oddspedia.match_collector.time.sleep", return_value=None)
    @patch("src.oddspedia.match_collector._fetch_all_matches", return_value={})
    @patch("src.oddspedia.match_collector._extract_matches_from_sports_events", return_value={})
    @patch("src.oddspedia.match_collector._extract_matches_vuex", return_value={})
    @patch("src.oddspedia.match_collector._navigate_to_date", return_value=True)
    @patch("src.oddspedia.match_collector._dismiss_cookie_popup")
    @patch("src.oddspedia.match_collector.safe_get")
    ...
    @patch("src.oddspedia.match_collector._fetch_all_matches")
    @patch("src.oddspedia.match_collector._dismiss_cookie_popup")
    @patch("src.oddspedia.match_collector._navigate_to_date", side_effect=[False, False])
    @patch("src.oddspedia.match_collector.safe_get", return_value=True)
    ...
    @patch("src.oddspedia.match_collector.time.sleep", return_value=None)
    @patch(
        "src.oddspedia.match_collector._read_displayed_date",
